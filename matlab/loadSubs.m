...
if isempty(varargin)
    temp = readtable(['limbxload/completed/' subType '/subs.xlsx'],'ReadVariableNames',0);
    ...
    save(['limbxload/completed/' subType '/subs.mat'],'subAll')
else
    load(['limbxload/completed/' subType '/subs.mat'])
end