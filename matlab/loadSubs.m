...
if isempty(varargin)
    temp = readtable(['limbxload/matlab/completed/' subType '/subs.xlsx'],'ReadVariableNames',0);
    ...
    save(['limbxload/matlab/completed/' subType '/subs.mat'],'subAll')
else
    load(['limbxload/matlab/completed/' subType '/subs.mat'])
end